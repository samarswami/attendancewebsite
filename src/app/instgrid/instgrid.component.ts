...
@Component({
  selector: 'app-instgrid',
  templateUrl: './instgrid.component.html',
  styleUrls: ['./instgrid.component.css']
})

export class InstgridComponent implements OnInit {
  displayedColumns = ['InstID', 'instName', 'instAddr', 'spocName', 'spocContact', 'InstContact', 'actions'];
  ...
  startEdit(i: number, InstID: string, instName: string, instAddr: string, spocName: string, SPOCCtc: number, InstCtc: number) {
    this.id = InstID;
